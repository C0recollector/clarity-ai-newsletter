...
TECHNICAL_SECTION_MAP = {
    "model-news": {
        ...
        "title": "Model News",
        "nav": "Model News",
        "nav_summary": "New models released, with a focus on capability, pricing, and benchmarks.",
    },
    "agents": {
        "id": "agents",
        "title": "Agents",
        "nav": "Agents",
        "nav_summary": "Agentic workflows, agent OS ideas, orchestration, tools, roles, artifacts, validation, and practical automation.",
    },
    "platforms": {
        "id": "platforms",
        "title": "Platform Plays",
        "nav": "Platform Plays",
        "nav_summary": "AI platforms pushing into everyday work surfaces.",
    },
    "infrastructure": {
        "id": "infrastructure",
        "title": "AI Infrastructure",
        "nav": "AI Infrastructure",
        "nav_summary": "Compute access, chips, power, memory, and data-center capacity.",
    },
    "power-moves": {
        "id": "power-moves",
        "title": "Power Moves",
        "nav": "Power Moves",
        "nav_summary": "Founder drama, lawsuits, acquisitions, partnerships, platform politics, and titan maneuvering.",
    },
    "robotics": {
        "id": "robotics",
